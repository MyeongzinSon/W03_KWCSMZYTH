...
public class _Tetrimino : MonoBehaviour
{
    public TetriminoType type;
    public Vector3 spawnOffset;

    Rigidbody2D rb;
    _TetrisManager gameManager;
    ...
    void Start()
    {
        ...
        gameManager = FindObjectOfType<_TetrisManager>();
    }
    ...
    {
        var rotationInfo = _TetrisGrid.Instance.CheckRotate(this, isClockwise);
        ...
        else
        {
            ...
            var v = Vector2.right * rotationInfo.aOffset + Vector2.up * rotationInfo.bOffset;
            Debug.Log($"movingOffset : {v}");
